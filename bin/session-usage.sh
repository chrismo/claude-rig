...
render() {
  ...
  printf '  cuml     cumulative total tokens (all columns). Steep\n'
  printf '           slope = fast burn; flat = idle. Pair with\n'
  printf '           --start-pct / --end-pct to anchor to a known\n'
  printf '           rate-limit percentage.\n'
