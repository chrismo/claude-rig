...
mkdir -p "$LOCAL_BIN"
for cmd in claude-slot claude-tabs claude-search agent-search claude-pod claude-peer claude-src claude-spend work-context gt wt wt-new ticket-sort kaomoji; do
